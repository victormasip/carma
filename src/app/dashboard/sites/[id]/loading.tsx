      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-2.5">
            <div className="h-8 w-52 bg-neutral-200 rounded-xl" />
            <div className="h-3 w-40 bg-neutral-100 rounded-lg" />
          </div>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div className="h-5 w-8 bg-neutral-100 rounded-lg" />
          </div>
          <div className="flex gap-2">
        ...
        <div className="space-y-2.5">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="bg-white border border-neutral-100 rounded-2xl overflow-hidden flex items-stretch"
              style={{ opacity: 1 - i * 0.12 }}
            >
              <div className="w-1 shrink-0 bg-neutral-200" />
              <div className="flex-1 flex items-center gap-4 px-5 py-4">
                <div className="flex-1 space-y-2">
                  <div className="h-4 bg-neutral-200 rounded-lg" style={{ width: `${55 + (i % 3) * 15}%` }} />
                  <div className="h-3 bg-neutral-100 rounded-md" style={{ width: `${30 + (i % 2) * 12}%` }} />
                </div>
